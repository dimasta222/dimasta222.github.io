...
export const SERVICE_PHOTOS = {
  ...
  termopechat: {
    ...
    gallery: [
      makeSlide(serviceImage("termopechat", "photo_2026-06-27_18-13-34.jpg"), "логотип", "Термопечать", "Лаконичный принт пленкой", "Ровные края и чистый вид на готовом изделии."),
      makeSlide(serviceImage("termopechat", "photo_2026-06-28_15-42-57.jpg"), "форма", "Термопечать", "Персонализация одежды", "Пример термопечати для формы, футболок и небольших партий."),
      makeSlide(serviceImage("termopechat", "photo_2026-06-28_15-42-48.jpg"), "пример", "Термопечать", "Готовая работа с термопереносом", "Реальный пример нанесения термотрансферной пленки на изделие."),
      makeSlide(serviceImage("termopechat", "photo_2026-06-26_20-15-04.jpg"), "тираж", "Термопечать", "Пример заказа термопечати", "Готовое нанесение для небольшого тиража или персонализации."),
      makeSlide(serviceImage("termopechat", "photo_2026-06-28_15-43-58.jpg"), "работа", "Термопечать", "Пример готового изделия", "Свежая работа с термотрансферной пленкой из нашей мастерской."),
      makeSlide(serviceImage("termopechat", "photo_2026-06-28_15-42-54.jpg"), "пленка", "Термопечать", "Аккуратный принт пленкой", "Четкий контур и плотный цвет для лаконичных надписей и графики."),
      makeSlide(serviceImage("termopechat", "photo_2026-06-27_18-09-55.jpg"), "номер", "Термопечать", "Нанесение на одежду", "Термоперенос для номеров, фамилий, логотипов и простых макетов."),
      makeSlide(serviceImage("termopechat", "photo_2026-06-28_15-43-00.jpg"), "деталь", "Термопечать", "Деталь нанесения", "Близкий пример результата после переноса под термопрессом."),
    ],
  },
  shelkografiya: {
